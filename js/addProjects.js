...
document.addEventListener("DOMContentLoaded", () => {
  ...
  Projects.forEach(item => {
    ...
    text += `<br><div class="project-div"><br><h3>&nbsp&nbsp${item.name}</h3>&nbsp&nbsp&nbspGitHub仓库：${github}<br>&nbsp&nbsp&nbspGitCode仓库：${gitcode}<br>&nbsp&nbsp&nbsp下载页面链接：${download}<br><br></div><br><br>`;
  });
